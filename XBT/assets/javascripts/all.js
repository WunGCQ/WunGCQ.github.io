	...
	var Header = (function () {
	  ...
	  _createClass(Header, [{
	    ...
	    value: function bind() {
	      ...
	      $('.btn_logout', this.dom).click(function () {
	        user.logout();
	      });
